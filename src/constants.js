...
export const SCORE_BONUS = new Int16Array(TEAM_STAT._COUNT);

SCORE_BONUS[TEAM_STAT.UNITS_BUILT] = 500;
SCORE_BONUS[TEAM_STAT.UNITS_KILLED] = 1000;
SCORE_BONUS[TEAM_STAT.UNITS_LOST] = -100;
SCORE_BONUS[TEAM_STAT.STRUCTURES_CAPTURED] = 2500;
SCORE_BONUS[TEAM_STAT.STRUCTURES_LOST] = -1000;
SCORE_BONUS[TEAM_STAT.RESOURCES_COLLECTED] = 1;
...
export const UNIT_MIN_JAMMER_RANGE = 1;
export const UNIT_MAX_JAMMER_RANGE = 4;
export const UNIT_MIN_MOVE_COST = 1;
export const UNIT_MAX_MOVE_COST = 99;