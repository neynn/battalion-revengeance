...
Autotiler.prototype.setType = function(typeID) {
    let count = 0;

    switch(typeID) {
        case Autotiler.TYPE.MIN_4: {
            this.type = Autotiler.TYPE.MIN_4;
            count = Autotiler.TYPE_SIZE.MIN_4;
            break;
        }
        case Autotiler.TYPE.MIN_8: {
            this.type = Autotiler.TYPE.MIN_8;
            count = Autotiler.TYPE_SIZE.MIN_8;
            break;
        }
        default: {
            console.warn(`Autotiler type ${typeID} does not exist!`);
            count = Autotiler.TYPE_SIZE.NONE;
            break;
        }
    }
