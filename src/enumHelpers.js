import { ENTITY_CATEGORY, ENTITY_TYPE, MOVEMENT_TYPE, TEAM_STAT, TILE_ID, TILE_TYPE, TRANSPORT_TYPE } from "./enums.js";
...
export const mapTransportToEntity = function(transportType) {
    switch(transportType) {
        ...
        default: return ENTITY_TYPE._INVALID;
    }
}

export const transportToCost = function(transportType) {
    switch(transportType) {
        case TRANSPORT_TYPE.BARGE: return 0;
        case TRANSPORT_TYPE.PELICAN: return 0;
        case TRANSPORT_TYPE.STORK: return 0;
        default: return 0;
    }
}
